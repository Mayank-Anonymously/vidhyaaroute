...
const HomeBanner = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: "Explore top-ranked universities across the globe with our comprehensive guidance. From application assistance to visa processing, we make your dream education accessible and achievable.",
      link: "/universities"
    },
    {
      id: 3,
      ...
      description: "Join thousands of successful students who trusted us with their international education dreams. Get personalized counseling and expert support every step of the way.",
      link: "/contact"
    }
  ];
          ...
          <div className="banner-content">
            ...
            >
              <h1 className="display-5 fw-bold mb-3">
                ...
                <span className="text-highlight">{currentSlideData.highlight}</span>
              </h1>
              ...
              <div className='d-flex justify-content-start'>
                <a href={currentSlideData.link}>
                  <button className="transparent-btn fw-semibold px-4 py-2 d-inline-flex align-items-center">
                    More Details <ArrowRight className="ms-2" size={16} />
                  </button>
                </a>
              </div>
            </div>
