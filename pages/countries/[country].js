...
const UniversitiesDetails = ({ data, unidata }) => {
	const whyStudyUK = [
	...
	const topUniversities = [
		{
			...
			description:
				'The oldest university in the English-speaking world, renowned for academic excellence and research.',
			highlights: [
				'38 Colleges',
				'Rhodes Scholarships',
				'Alumni: 28 UK Prime Ministers',
			],
		...
		},
		{
			...
			description:
				'World-leading research university with 800+ years of academic tradition and innovation.',
			highlights: [
				'31 Colleges',
				'Trinity College',
				'Alumni: Stephen Hawking, Newton',
			],
		...
		},
		{
			...
			description:
				'Leading science, technology, engineering and medicine university in the heart of London.',
		...
		},
		{
			...
			description:
				'Specialist university focused on social sciences, economics, and political science.',
		...
		},
		{
			...
			description:
				"London's leading multidisciplinary university with a global reputation for research excellence.",
			highlights: [
				'Multidisciplinary',
				'Research Excellence',
				'Central Location',
		...
		},
		{
			...
			description:
				"Scotland's premier university combining historic tradition with cutting-edge research.",
			highlights: [
	...
	return (
		<>
			<Navbar />
			<BreadcrumbBanner title={`${data.title.toUpperCase()} Universities`} />
			<div
				className='container'
...
export const getServerSideProps = async (context) => {
	...
	return {
		props: {
			...
			unidata: ress.data.response || null, // safe optional chaining
		},
	};
};
